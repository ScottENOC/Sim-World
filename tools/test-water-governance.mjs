...
import {
  ...
  waterEmigrationAnnualRate, waterMigrationPull,
...
setWaterGovernancePolicy(unfair,{householdPriority:.12,industryPriority:1,restrictionSeverity:.7,scarcityPricing:.55},{playerIssued:true});
unfair.waterResources.householdSatisfaction=.42;unfair.waterResources.industrySatisfaction=.94;unfair.waterResources.irrigationSatisfaction=.72;
