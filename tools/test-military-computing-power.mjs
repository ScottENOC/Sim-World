...
const poweredReliability=powered.reliability;
...
assert(failed.reliability<poweredReliability,'base electrical reliability should collapse when generator fuel is exhausted');
