...
assert.equal(advisorForReport('Foreign steel observed', 'Traders brought unfamiliar steel tools.'), 'treasurer', 'trade channel should surface via the Treasurer when the report is explicitly about traders');
