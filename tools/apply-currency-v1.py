...
# State finance: trusted currency improves collection/admin/payroll; distrusted currency can reverse it.
...
# Trade: currency lowers settlement friction when trusted, especially within the same currency area.
...
# Polities own currencies and propagate them to their territories each polity tick.
...
# Load the currency menu UI and force a fresh main module on iOS Safari.
replace_once('index.html',
"  <script type=\"module\" src=\"js/ui/culturalLifeUi.js?v=20260907-art1\"></script>\n  <script type=\"module\" src=\"js/main.js?v=20260912-culture-scaling1\"></script>",
