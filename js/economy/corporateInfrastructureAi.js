...
export function tickExistingCorporateInfrastructure(regions,elapsedDays){for(const region of regions||[])for(const asset of ensureCorporateInfrastructure(region).assets||[])tickCorporateInfrastructureAsset(asset,region,elapsedDays);}
