...
export function tickEconomy(regions,seaRegions,toolTypes,rng=Math.random,currentTick=null,elapsedDays=7,endDay=null){
  ...
  for(const region of regions){tickPrecisionAgriculture(region,elapsedDays);tickCropBiotechnology(region,elapsedDays);tickLivestockAgriculture(region,elapsedDays);}
