...
export function renderLabourRelationsControls(){
  ...
  document.getElementById('labour-protection')?.addEventListener('input',e=>{const v=Number(e.target.value)/100;applyPolity({importProtection:v});document.getElementById('labour-protection-label').textContent=pct(v);});
}
