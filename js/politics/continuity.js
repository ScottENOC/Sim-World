 ...
 * pressure; covert leadership shocks then alter elite legitimacy/coup conditions;
 * institutional pressure can then produce coups or revolutions; the existing
 * continuity/exile pass runs last against the resulting sovereignty.
 */
export function tickPoliticalContinuity(polities, regions, elapsedYears = 0, currentTick = 0, options = {}) {
  ...
  return [...popularEvents, ...leadershipEvents, ...institutionalEvents, ...regimeEvents, ...continuityEvents];
}