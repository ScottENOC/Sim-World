...
export const OFFWORLD_TECH_IDS=Object.freeze({
  ...
  MARS_PROPELLANT_ISRU:MARS_PROPELLANT_ISRU_TECH_ID,
});
...
const TECH_STEPS=Object.freeze([
  ...
  {id:CRYOGENIC_ROCKET_PROPELLANT_TECH_ID,label:'Cryogenic rocket propellant',requiresMilestones:['first_human_orbit'],requiresTech:['water_electrolysis',SPACE_TECH_IDS.SPACEFLIGHT_ROCKETRY],base:.0026},
  {id:OFFWORLD_TECH_IDS.MARS_PROPELLANT_ISRU,label:'Mars propellant ISRU',requiresMilestones:['first_mars_base'],requiresTech:[CRYOGENIC_ROCKET_PROPELLANT_TECH_ID,OFFWORLD_TECH_IDS.MARS_SURFACE_HABITATION],base:.0018},
]);
...
function newHabitat(id,spec,currentTick){const h={id,label:spec.label,body:spec.body,active:true,foundedTick:currentTick,crew:spec.initialCrew,capacity:spec.initialCapacity,condition:1,resupplyReliability:1,lifeSupportReliability:.92,powerCapacityKw:spec.initialPowerKw,powerDemandKw:spec.initialPowerKw*.58,powerReliability:.92,greenhouseModules:0,greenhouseExperience:0,greenhouseReliability:0,foodSelfSufficiency:0,lastAnnualisedCashCost:0,lastAnnualisedFuelCost:0,cumulativeResupplyCost:0,cumulativeFuelUse:0,shortageDays:0};if(id==='mars')ensureMarsPropellantIsru(h);return h;}
