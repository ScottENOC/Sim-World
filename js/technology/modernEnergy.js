...
import { OFFSHORE_WIND_TECH_ID, GEOTHERMAL_TECH_ID, WATER_ELECTROLYSIS_TECH_ID, HYDROGEN_TRANSPORT_TECH_ID, HYDROGEN_POWER_TECH_ID, FUEL_ETHANOL_TECH_ID } from '../economy/energyTransition.js?v=20260923-energy-transition1';
...
export { OFFSHORE_WIND_TECH_ID, GEOTHERMAL_TECH_ID, WATER_ELECTROLYSIS_TECH_ID, HYDROGEN_TRANSPORT_TECH_ID, HYDROGEN_POWER_TECH_ID, FUEL_ETHANOL_TECH_ID };

const ZERO_ENERGY_CHANCES=Object.freeze({gas:0,turbine:0,lng:0,carrier:0,solar:0,offshoreWind:0,geothermal:0,electrolysis:0,hydrogenTransport:0,hydrogenPower:0,ethanol:0,leadAcid:0,advancedBattery:0,lithiumIon:0});
...
export function tickModernEnergyBreakthroughs(regions,currentTick,rng=Math.random,elapsedDays=7){
  ...
  const attempts=[['gas',NATURAL_GAS_EXTRACTION_TECH_ID,'natural_gas_breakthrough','Natural-gas production','Drilling and gas-handling methods make commercial natural-gas production practical.'],['turbine',GAS_TURBINE_GENERATION_TECH_ID,'gas_turbine_breakthrough','Gas-turbine generation','Flexible gas-fired generating plant can now support electrical grids.'],['lng',LNG_PROCESSING_TECH_ID,'lng_processing_breakthrough','Liquefied natural gas','Industrial refrigeration and gas handling make bulk LNG export and import practical.'],['carrier',LNG_CARRIER_TECH_ID,'lng_carrier_breakthrough','LNG carrier design','Specialised insulated merchant ships can now carry LNG between equipped terminals.'],['solar',PHOTOVOLTAIC_GENERATION_TECH_ID,'photovoltaic_breakthrough','Photovoltaic generation','Semiconductor manufacturing has matured enough for practical grid-connected solar generation.'],['offshoreWind',OFFSHORE_WIND_TECH_ID,'offshore_wind_breakthrough','Offshore wind generation','Marine engineering and grid technology make large offshore wind farms practical.'],['geothermal',GEOTHERMAL_TECH_ID,'geothermal_generation_breakthrough','Geothermal generation','Deep drilling and turbine systems make dependable geothermal electricity practical where geology permits.'],['electrolysis',WATER_ELECTROLYSIS_TECH_ID,'water_electrolysis_breakthrough','Industrial water electrolysis','Large electrolysers can turn surplus electricity into storable hydrogen at substantial conversion cost.'],['hydrogenTransport',HYDROGEN_TRANSPORT_TECH_ID,'hydrogen_transport_breakthrough','Hydrogen transport fuels','High-pressure and cryogenic fuel systems make hydrogen usable in specialised transport applications.'],['hydrogenPower',HYDROGEN_POWER_TECH_ID,'hydrogen_power_breakthrough','Hydrogen power generation','Modified turbines and fuel systems can turn stored hydrogen back into dispatchable grid electricity.'],['ethanol',FUEL_ETHANOL_TECH_ID,'fuel_ethanol_breakthrough','Fuel ethanol blending','Industrial fermentation and fuel standards allow crop-derived ethanol to extend petrol supplies in controlled blends.'],['leadAcid',BATTERY_TECH_IDS.LEAD_ACID,'lead_acid_battery_breakthrough','Rechargeable batteries','Practical rechargeable lead-acid cells make stored electrical power useful for stationary and mobile applications.'],['advancedBattery',BATTERY_TECH_IDS.ADVANCED,'advanced_battery_breakthrough','Advanced rechargeable batteries','Improved rechargeable chemistries provide better endurance, cycle life and portable power.'],['lithiumIon',BATTERY_TECH_IDS.LITHIUM_ION,'lithium_ion_battery_breakthrough','Lithium-ion batteries','Advanced materials and electronics make high-energy rechargeable cells practical at industrial scale.']];
